...
export const en = {
  ...
  checkout: {
    ...
    fulfillment: {
      ...
      delivery: 'Delivery',
      deliveryHint: 'We deliver to your address',
      pickup: 'Store pickup',
      pickupHint: 'Collect your order from one of our showrooms — free',
      selectLocation: 'Select showroom',
      noLocations: 'No showrooms are available for pickup right now',
      pickupFree: 'Free',
    },
    ...
    pickupCodeHint: 'Show this code when you collect your order at the showroom.',
