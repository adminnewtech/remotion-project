-- Elite v1 — checkout SQL helpers.
--
-- ⚠️ THIS BELONGS IN A MIGRATION. Copy into a new file such as
--    supabase/migrations/0007_checkout_helpers.sql
-- and apply via the migration pipeline. It is kept here only so the
-- `checkout` Edge Function has a documented, atomic stock-reservation path.
-- Do not run it ad-hoc against production.
